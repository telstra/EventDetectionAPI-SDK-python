...
from Telstra_EventDetection.api_client import ApiClient
...
class PushNotificationsApi(object):
    ...
    def push_notifications(self, content_type, body, **kwargs):  # noqa: E501
        """Push event notifications  # noqa: E501

        Push event notifications to the notification URL configured during the MSISDN registration process  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async=True
        >>> thread = api.push_notifications(content_type, body, async=True)
        >>> result = thread.get()

        :param async bool
        :param str content_type: application/json (required)
        :param NotificationPayload body: Application Id, MSISDN, Event Id and Event Date (required)
        ...
        if kwargs.get('async'):
            return self.push_notifications_with_http_info(content_type, body, **kwargs)  # noqa: E501
        else:
            (data) = self.push_notifications_with_http_info(content_type, body, **kwargs)  # noqa: E501
            return data

    def push_notifications_with_http_info(self, content_type, body, **kwargs):  # noqa: E501
        """Push event notifications  # noqa: E501

        Push event notifications to the notification URL configured during the MSISDN registration process  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async=True
        >>> thread = api.push_notifications_with_http_info(content_type, body, async=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    ...
                    " to method push_notifications" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        if ('content_type' not in params or
            ...
            raise ValueError("Missing the required parameter `content_type` when calling `push_notifications`")  # noqa: E501
        # verify the required parameter 'body' is set
        if ('body' not in params or
                params['body'] is None):
            raise ValueError("Missing the required parameter `body` when calling `push_notifications`")  # noqa: E501
        ...
        return self.api_client.call_api(
            ...
            response_type='PushNotificationObj',  # noqa: E501
