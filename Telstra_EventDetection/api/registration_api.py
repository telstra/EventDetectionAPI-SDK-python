...
class RegistrationApi(object):
    ...
    def register(self, body, **kwargs):  # noqa: E501
        ...
        Register for an event  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async=True
        >>> thread = api.register(body, async=True)
        >>> result = thread.get()

        :param async bool
        :param SubscriptionObj body: Subscribe with a list of phone numbers, push notification URL (optional) and the event type. (required)
    ...
    def register_with_http_info(self, body, **kwargs):  # noqa: E501
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async=True
        >>> thread = api.register_with_http_info(body, async=True)
        >>> result = thread.get()
        ...
        return self.api_client.call_api(
            ...
            response_type='ResisterPhoneNumberList',  # noqa: E501
    ...
    def unregister(self, event_type, body, **kwargs):  # noqa: E501
        """Unregister  # noqa: E501

        Unregister from an event  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async=True
        >>> thread = api.unregister(event_type, body, async=True)
        >>> result = thread.get()

        :param async bool
        :param str event_type: Event Type (required)
        :param UnregisterRequestObj body: List of subscribed phone numbers and notification URL (optional) (required)
        :return: ResisterPhoneNumberList
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async'):
            return self.unregister_with_http_info(event_type, body, **kwargs)  # noqa: E501
        else:
            (data) = self.unregister_with_http_info(event_type, body, **kwargs)  # noqa: E501
            return data

    def unregister_with_http_info(self, event_type, body, **kwargs):  # noqa: E501
        """Unregister  # noqa: E501

        Unregister from an event  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async=True
        >>> thread = api.unregister_with_http_info(event_type, body, async=True)
        >>> result = thread.get()
        ...
        if ('event_type' not in params or
            ...
            raise ValueError("Missing the required parameter `event_type` when calling `unregister`")  # noqa: E501
        # verify the required parameter 'body' is set
        if ('body' not in params or
                params['body'] is None):
