...
class GetSubscriptionApi(object):
    ...
    def get_subscription(self, body, **kwargs):  # noqa: E501
        """Get Event Subscriptions  # noqa: E501

        Get the list of events subscribed for  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async=True
        >>> thread = api.get_subscription(body, async=True)
        >>> result = thread.get()

        :param async bool
        :param PhoneNumberList body: List of subscribed phone numbers (required)
        ...
        if kwargs.get('async'):
            return self.get_subscription_with_http_info(body, **kwargs)  # noqa: E501
        else:
            (data) = self.get_subscription_with_http_info(body, **kwargs)  # noqa: E501
            return data

    def get_subscription_with_http_info(self, body, **kwargs):  # noqa: E501
        """Get Event Subscriptions  # noqa: E501

        Get the list of events subscribed for  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async=True
        >>> thread = api.get_subscription_with_http_info(body, async=True)
        >>> result = thread.get()
        ...
        if ('body' not in params or
                params['body'] is None):
            raise ValueError("Missing the required parameter `body` when calling `get_subscription`")  # noqa: E501
