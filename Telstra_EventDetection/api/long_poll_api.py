...
class LongPollApi(object):
    ...
    def longpoll(self, event_type, body, **kwargs):  # noqa: E501
        """Poll events  # noqa: E501

        Poll events for a given set of MSISDNs  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async=True
        >>> thread = api.longpoll(event_type, body, async=True)
        >>> result = thread.get()

        :param async bool
        :param str event_type: Event Type (required)
        :param PollingObj body: List of MSISDNs to pull the events (required)
        ...
        if kwargs.get('async'):
            return self.longpoll_with_http_info(event_type, body, **kwargs)  # noqa: E501
        else:
            (data) = self.longpoll_with_http_info(event_type, body, **kwargs)  # noqa: E501
            return data

    def longpoll_with_http_info(self, event_type, body, **kwargs):  # noqa: E501
        """Poll events  # noqa: E501

        Poll events for a given set of MSISDNs  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async=True
        >>> thread = api.longpoll_with_http_info(event_type, body, async=True)
        >>> result = thread.get()
        ...
        if ('event_type' not in params or
            ...
            raise ValueError("Missing the required parameter `event_type` when calling `longpoll`")  # noqa: E501
        # verify the required parameter 'body' is set
        if ('body' not in params or
                params['body'] is None):
            raise ValueError("Missing the required parameter `body` when calling `longpoll`")  # noqa: E501
