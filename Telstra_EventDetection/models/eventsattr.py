...
from Telstra_EventDetection.models.service_events_attr import ServiceEventsAttr  # noqa: F401,E501


class Eventsattr(object):
    ...
    swagger_types = {
        'msisdn': 'str',
        'mobile_service_events': 'list[ServiceEventsAttr]'
    }

    attribute_map = {
        'msisdn': 'msisdn',
        'mobile_service_events': 'mobileServiceEvents'
    }

    def __init__(self, msisdn=None, mobile_service_events=None):  # noqa: E501
        """Eventsattr - a model defined in Swagger"""  # noqa: E501

        self._msisdn = None
        self._mobile_service_events = None
        self.discriminator = None

        self.msisdn = msisdn
        self.mobile_service_events = mobile_service_events

    @property
    def msisdn(self):
        """Gets the msisdn of this Eventsattr.  # noqa: E501

        MSISDN  # noqa: E501

        :return: The msisdn of this Eventsattr.  # noqa: E501
        :rtype: str
        """
        return self._msisdn
    ...
    def msisdn(self, msisdn):
        """Sets the msisdn of this Eventsattr.

        MSISDN  # noqa: E501

        :param msisdn: The msisdn of this Eventsattr.  # noqa: E501
        :type: str
        """
        if msisdn is None:
    ...
    @property
    def mobile_service_events(self):
        """Gets the mobile_service_events of this Eventsattr.  # noqa: E501

        Array of mobile events  # noqa: E501

        :return: The mobile_service_events of this Eventsattr.  # noqa: E501
        :rtype: list[ServiceEventsAttr]
        """
        return self._mobile_service_events

    @mobile_service_events.setter
    def mobile_service_events(self, mobile_service_events):
        """Sets the mobile_service_events of this Eventsattr.

        Array of mobile events  # noqa: E501

        :param mobile_service_events: The mobile_service_events of this Eventsattr.  # noqa: E501
        :type: list[ServiceEventsAttr]
        """
        if mobile_service_events is None:
            raise ValueError("Invalid value for `mobile_service_events`, must not be `None`")  # noqa: E501

        self._mobile_service_events = mobile_service_events
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, Eventsattr):
            return False
